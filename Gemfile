...
gem 'geocoder', '1.6.3'        # Complete geocoding solution for Ruby.
...
group :development, :test do
  ...
  gem 'rspec-rails', '4.0.1'       # RSpec testing framework to Ruby on Rails
...
group :development do
  ...
  gem 'listen', '~> 3.2'        # Listens to file modifications and notifies you about the changes.
  gem 'spring'                  # Spring speeds up development by keeping your application running in the background.
  gem 'spring-watcher-listen', '~> 2.0.0'
end

group :test do
  gem 'capybara', '3.32.2'  # Adds support for Capybara system testing and selenium driver
